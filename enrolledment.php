...
$stmt = $conn->query("SELECT * FROM student ORDER BY s_id DESC LIMIT 1");
$row = $stmt->fetch_assoc();
$idd = substr($row['p_id'], 3, 5);

$pinfo = $conn->prepare("SELECT * FROM parents WHERE id = ?");
$pinfo->bind_param("i", $idd);
$pinfo->execute();
$result = $pinfo->get_result();
    ...
    <div class="body-wrapper"><div class="limiter">
      ...
      <h4>Information</h4>
        ...
        <tr>
          ...
          <td>
              <h3><?php 
              echo $rowss['name'];?></h3></td>
        </tr>

        <tr>
          <td><h2>Students's Name: </h2></td>
          <td>
        ...
        <tr>
          ...
          <td>
              <h3><?php
              echo $row['driver_id'];?></h3></td>
        </tr>

        <tr>
          <td><h2>RFID: </h2></td>
          <td>
              <h3><?php echo $row['rfid'];?></h3></td>
        </tr>
      </table>	        
