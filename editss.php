    ...
    <div class="body-wrapper"><div class="limiter">
      ...
      <div class="wrap-login100">
                ...
                <span class="login100-form-title">
                    ...
                    <div class="wrap-input100 validate-input">
                        <h6>Parent's Name</h6>
						<input class="input100" type="text" name="pn" id="pn" disabled value=<?php echo $row2['name'] ?> disabled>
						<span class="focus-input100"></span>
					</div>

                    <div class="wrap-input100 validate-input">
                        <h6>Driver Name</h6>
						<input class="input100" type="text" name="dn" id="dn" required placeholder="Write 'None' if leaving" value=<?php echo $row3['name'] ?> "None"  disabled>
						<span class="focus-input100"></span>
					</div>
...
if (isset($_POST['submit'])) {
    try {
        ...
        $stmt1 = $pdo->prepare("UPDATE student SET `name` = :name WHERE s_id = :s_id");
...
<script type="text/javascript">
    window.location = "schoolstudents.php";
