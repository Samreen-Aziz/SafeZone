      ...
      <div class="wrap-login100">
                ...
                <span class="login100-form-title">
                    ...
                    <div class="wrap-input100 validate-input">
                        <h6>ID</h6>
						<input class="input100" type="text" name="id" id="id" placeholder="ID" value=<?php echo $row['d_id'].$row['d_prefix'] ?> disabled>
                    ...
                    <div class="wrap-input100 validate-input">
                        <h6>Mobile Number</h6>
						<input class="input100" type="tel" name="number" id="number" placeholder="Ex: 03221234567" pattern="[0-9]{11}" required value=<?php echo $row['phone'] ?>>
						<span class="focus-input100"></span>
					</div>

                    <div class="wrap-input100 validate-input">
                        <h6>Email</h6>
						<input class="input100" type="email" name="email" id="email" placeholder="Email" required value=<?php echo $row['email'] ?>>
						<span class="focus-input100"></span>
					</div>
                    ...
                    <div class="wrap-input100 validate-input">
						...
						<input class="input100" type="text" name="vno" id="vno" placeholder="Ex: AAA123" required pattern="[A-Z]{3}[0-9]{3}" value=<?php echo $row['vehicle_number'] ?>>
						<span class="focus-input100"></span>
					</div>
...
if (isset($_POST['submit'])) {
  try {
      ...
      $stmt1 = $pdo->prepare("UPDATE driver SET name = :name, phone = :phone, email = :email, address = :address, vehicle_number = :vehicle WHERE d_id = :d_id");

      
      // Bind the parameters for statement 1
      $stmt1->bindParam(':d_id', $d_id);
