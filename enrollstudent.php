      ...
      <div class="wrap-login100">
				...
				<form class="login100-form validate-form" action = '' method = 'POST'>
					...
					<div class="wrap-input100 validate-input">
                        <h6>Parent's Id</h6>
						<input class="input100" type="text" name="pid" id="pid" value = <?php foreach($rows as $row){
            ...
            <span class="focus-input100"></span>
                    ...
                    <div class="wrap-input100 validate-input">
                        <h6>RFID</h6>
						<input class="input100" type="tel" name="rfid" id="rfid" placeholder="Ex: 9876" pattern="[0-9]{4}">
						<span class="focus-input100"></span>
					</div>
...
if (isset($_POST['submit'])) {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO student (s_id, p_id, prefix, d_id, d_prefix, rfid, name) VALUES (NULL, :p_id, :prefix, :driver_id, :d_prefix, :rfid, :name)");
